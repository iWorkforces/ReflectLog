...
from openmemories.application.config.prompts import (
    INSTRUCTIONS_HEADER,
    TOOL_ORDER,
    build_instructions,
)
...
class TestBuildInstructions:
    ...
    def test_header_always_present(self):
        ...
        assert "OpenMemoriesMCP MCP Server" in result
...
class TestToolInstructionSnippets:
    ...
    def test_add_tool_snippet_format(self, mock_memory_class, set_env_vars):
        ...
        from openmemories.application.tools import AddTool
    ...
    def test_get_all_tool_snippet_format(self, mock_memory_class, set_env_vars):
        ...
        from openmemories.application.tools import GetAllTool
    ...
    def test_search_tool_snippet_format(self, mock_memory_class, set_env_vars):
        ...
        from openmemories.application.tools import SearchTool
    ...
    def test_remove_tool_snippet_format(self, mock_memory_class, set_env_vars):
        ...
        from openmemories.application.tools import RemoveTool
...
class TestDynamicInstructionsIntegration:
    ...
    def _build_server_and_capture_instructions(
        ...
        with (
            patch(
                "openmemories.application.mcp_server.FastMCP",
                side_effect=capture_fastmcp,
            ),
            patch("openmemories.application.mcp_server.MemoryManager"),
            patch(
    ...
    def test_instructions_header_always_present(self, monkeypatch):
        ...
        assert "OpenMemoriesMCP MCP Server" in instructions
...
class TestBackwardCompatibility:
    ...
    def test_mcp_instructions_constant_includes_all_tools(self):
        ...
        from openmemories.application.config.prompts import MCP_INSTRUCTIONS
    ...
    def test_mcp_instructions_has_header(self):
        ...
        assert "OpenMemoriesMCP MCP Server" in MCP_INSTRUCTIONS
