...
class TestValidateMessages:
    """Test suite for _validate_messages() method."""

    def test_empty_list_is_valid(self, mcp_server):
        """Test that empty list is valid (no-op case)."""
        is_valid, error_msg = mcp_server._validate_messages([])
        assert is_valid is True
        assert error_msg == ""

    def test_single_valid_message(self, mcp_server):
        """Test validation of single valid message."""
        is_valid, error_msg = mcp_server._validate_messages(["Hello, World!"])
        assert is_valid is True
        assert error_msg == ""

    def test_multiple_valid_messages(self, mcp_server, sample_messages):
        """Test validation of multiple valid messages."""
        is_valid, error_msg = mcp_server._validate_messages(sample_messages["multiple"])
        assert is_valid is True
        assert error_msg == ""

    def test_message_with_special_characters(self, mcp_server):
        """Test validation of messages with special characters."""
        messages = [
            "Message with special chars: !@#$%^&*()",
            "Unicode: 你好世界 🌍",
        ]
        is_valid, error_msg = mcp_server._validate_messages(messages)
        assert is_valid is True
        assert error_msg == ""

    def test_message_with_newlines_and_tabs(self, mcp_server):
    ...
    def test_message_at_min_length(self, mcp_server, sample_messages):
    ...
    def test_message_at_max_length(self, mcp_server, sample_messages):
    ...
    def test_message_with_leading_trailing_spaces(self, mcp_server):
    ...
    def test_non_string_message_invalid(self, mcp_server):
    ...
    def test_empty_string_invalid(self, mcp_server, sample_messages):
    ...
    def test_whitespace_only_message_invalid(self, mcp_server, sample_messages):
    ...
    def test_message_too_long_invalid(self, mcp_server, sample_messages):
    ...
    def test_mixed_valid_and_invalid_messages(self, mcp_server):
    ...
    def test_various_non_string_types(
        self, mcp_server, invalid_message, expected_error
    ):
    ...
    def test_various_empty_messages(self, mcp_server, invalid_message, expected_error):
    ...
    def test_error_message_includes_index(self, mcp_server):
    ...
    def test_multiple_messages_first_invalid(self, mcp_server):
    ...
    def test_multiple_messages_last_invalid(self, mcp_server):
    ...
    def test_message_exactly_one_over_max_length(self, mcp_server):
    ...
    def test_large_list_of_valid_messages(self, mcp_server):
    ...
    def test_large_list_with_one_invalid(self, mcp_server):
