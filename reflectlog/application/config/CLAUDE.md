# reflectlog/application/config/

This directory contains configuration management and system prompts for ReflectLogMCP.
...
```python
MCP_INSTRUCTIONS = """
ReflectLogMCP Server - Project-based memory storage for Claude Code.
...
|----|------|---|-------|------|
| #642 | 12:41 PM | 🔵 | Configuration Management Documentation | ~282 |
