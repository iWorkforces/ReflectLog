# reflectlog/application/memory/reranking/
...
```python
from reflectlog.application.memory.reranking import calculate_recency_factor
...
The core normalization uses `normalize_scores_minmax()` from `reflectlog.application.utils.numba_utils`:
...
- `reflectlog.application.utils.numba_utils`: JIT-compiled normalization
