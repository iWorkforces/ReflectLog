# reflectlog/infrastructure/

This directory contains infrastructure components and external integrations for ReflectLogMCP.
...
```python
from reflectlog.infrastructure import BaseOpenAIProvider, RelevanceScore
...
| `anthropic` | `AnthropicRerankerProvider` | Claude Agent SDK via `reflectlog.utility.generate_content()` |

**Factory Function:**
```python
from reflectlog.infrastructure import create_reranker_provider
...
```python
from reflectlog.infrastructure import LLMReranker, LLMRerankerConfig
...
- `anthropic`: Uses Claude Agent SDK via `reflectlog.utility.generate_content()` with OAuth credentials
...
```python
from reflectlog.infrastructure import TantivyConfig, TantivyEngine
...
```python
from reflectlog.infrastructure import LangchainQwenEmbeddings
